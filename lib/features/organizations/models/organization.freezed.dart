...
mixin _$Organization {
 ...
 int get id; String get name;@JsonKey(name: 'official_url') String get officialUrl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Organization&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.officialUrl, officialUrl) || other.officialUrl == officialUrl));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,officialUrl);

@override
String toString() {
  return 'Organization(id: $id, name: $name, officialUrl: $officialUrl)';
}
...
@useResult
$Res call({
 int id, String name,@JsonKey(name: 'official_url') String officialUrl
});
...
/// Create a copy of Organization
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? officialUrl = null,}) {
...
class _Organization implements Organization {
  const _Organization({required this.id, required this.name, @JsonKey(name: 'official_url') required this.officialUrl});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Organization&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.officialUrl, officialUrl) || other.officialUrl == officialUrl));
}
...
/// Create a copy of Organization
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? officialUrl = null,}) {
